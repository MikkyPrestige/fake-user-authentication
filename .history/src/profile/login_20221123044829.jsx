...
const Login = () => {
  ...
  const redirect = location.state?.path || "/"; // If the user is redirected to the login page, the path is stored in the location state. If the path is not stored, the user is redirected to the profile page
