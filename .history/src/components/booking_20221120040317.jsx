      ...
      <div className="booking__wrapper">
        <div className="booking__content">
          ...
          <div className="booking__description">
            <p className="booking__description--sub-paragraph">
            While the world has changed a lot over the years, one thing remains the same: everyone needs clean clothes! We have all types of services to meet your needs.
            </p>
            <h2 className="booking__description--head">
          ...
          <p>
          If you would like to schedule this services please call <span>07061516180</span> or <span>visit www.machalalaundryservice.com</span> Thank you for your continued support!
          </p>
          </div>
        </div>
