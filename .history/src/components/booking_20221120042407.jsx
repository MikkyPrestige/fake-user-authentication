      ...
      <div className="booking__wrapper">
        <div className="booking__content">
          ...
          <div className="booking__description">
            ...
            <p>
              If you would like to schedule this services please call{" "}
              <span>07061516180</span> or visit{" "}
              <span><a href="https://machalalaundryservice.com/" target="_blank" rel="noreferrer">www.machalalaundryservice.com</a></span> <br /> Thank you for your continued support!
            </p>
          </div>
        </div>
