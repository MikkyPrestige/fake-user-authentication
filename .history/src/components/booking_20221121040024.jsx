...
const Booking = () => {
  ...
  return (
    <div className="booking">
      <div className="booking__wrapper">        <div className="booking__content">
         ...
         <p>
            ...
            providing the best service to our customers. We are committed to providing the best service to our customers.
           </p>
           <p className="booking__appreciation">Thank you for choosing us. We look forward to serving you.
          </p>
         </div>
                </div>
