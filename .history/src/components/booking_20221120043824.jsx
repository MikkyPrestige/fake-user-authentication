...
const Booking = () => {
  ...
  return (
    <div className="booking">
      <div className="booking__wrapper">
        <div className="booking__content">
          ...
          <div className="booking__description">
            ...
            <p>
              We are a family owned and operated business. We have been in
              business for over 10 years. We have a team of experienced
              professionals who are dedicated to providing the best service to
              our customers. We are committed to providing the best service to
              our customers.
            </p>
          </div>
        </div>
      ...
      <Link to="/" className="booking__link">Back</Link>
    </div>
  );
};
