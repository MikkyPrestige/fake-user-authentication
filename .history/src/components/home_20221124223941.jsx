  ...
  return (
    <div className="home">
      ...
      <div className="home__content">
        ...
        <p className="home__paragraph">Visit our website <a href="https://machalalaundryservice.com/" target="_blank" rel="noreferrer">MachalaLaundryService</a></p>
        <p className="home__paragraph">
          Contact us on <a href="tel: ">08030849685</a> and <a href="mailto: ">machalalaundryservice@gmail.com</a>
        </p>
